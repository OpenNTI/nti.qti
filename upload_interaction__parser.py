...
class UploadInteraction(object):
    ...
    def to_qti(self, adaptive='false', time_dependent='false'):
        ...
        qti_file = open('/QTI_Questions/uploadInteraction_Questions/' + self.title + '.xml', 'w+', encoding="utf-8")
    ...
    def to_nti(self):
        ...
        nti_file = open('/NTI_Questions/FilePart_Questions/' + self.title + '.json', 'w+', encoding="utf-8")
